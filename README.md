...
- Busca de templates de memes via API
- Texto customizável no topo e na base da imagem
- Geração de memes em tempo real
- Interface simples e divertida

## Stack

- **React 19** + Vite
- Componentes JSX (Header, Main)

## Instalação

```bash
git clone https://github.com/ooshimakenji/bila-meme-generator.git
cd bila-meme-generator
npm install
npm run dev
```
